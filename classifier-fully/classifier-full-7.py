...
def training():
    ...
    out_file = open(working_path + project + "_metrics_full.csv", 'w', newline='', encoding="utf-8")
    ...
    ## Train
    dataset = pd.read_csv(working_path + project + "_metrics_full.csv")
